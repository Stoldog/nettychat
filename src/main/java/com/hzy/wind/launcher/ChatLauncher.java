...
public class ChatLauncher {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        tangtHost = args[1];
        System.out.println("0-url:"+url.toString());
        System.out.println("0-tangtHost:"+tangtHost);
        //服务器配置
        ...
        System.out.println("0-参数设置完毕");
        final SocketIOServer server = new SocketIOServer(config);
        //服务器监听事件
        SocketIONamespace socketIONamespace = server.addNamespace(nameSpace);
        System.out.println("0-socketIONamespace："+nameSpace);
        //监听连接事件
        socketIONamespace.addConnectListener(new ConnectListener() {
            ...
            public void onConnect(SocketIOClient client) {
                ...
                System.out.println("1-tokenStr:"+tokenStr);
                if(claims==null){
                ...
                if(roomId == null || roomId == 0){
                    System.out.println("Token Parse Error: roomId is null or 0");
                ...
                System.out.println("2-isPower:"+isPower);
                //增加权限及其他的参数
                ...
                System.out.println("3-joinRoom");
                // 3. 判断是否重复加入
                List<UserData> userDataList = new ArrayList<>();

                for (UUID uuid : socketIONamespace.getRoomClient(roomStr)) {
                    System.out.println("3.1-joinRoom: "+uuid);
                ...
                System.out.println("5-resUrl:"+resUrl);
                String tangtData = HttpClientUtil.httpGetRequest(resUrl.toString());
                System.out.println("6-tangtData:"+tangtData);
        ...
        System.out.println("0-其他监听器设置完毕");
        server.start();
    }
}
